Here are the hardware requirements for Llama 3 (including 3.1) models. 
The requirements vary significantly based on whether you run the **8B** (standard consumer) 
or **70B** (high-end/server) model, and the level of **Quantization** (compression) you use.
